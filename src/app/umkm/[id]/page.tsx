      ...
      <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="md:w-2/3 p-6">
            ...
            <p className="text-gray-500 italic mb-2">{umkm.jenis}</p>
            <p className="text-gray-700 mb-4">{umkm.deskripsi}</p>
        ...
        <div className="border-t p-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-3">Alamat</h2>
        ...
        <div className="border-t p-6 text-sm text-gray-500 text-right">
